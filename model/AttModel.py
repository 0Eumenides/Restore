...
class AttModel(Module):
    ...
    def __init__(self, in_features=48, d_model=512, num_stage=2, dct_n=10):
        ...
        self.restoration = Restoration(input_n=10, d_model=64, num_stage=num_stage,eta=6)
    ...
    def forward(self, src, label, output_n=10, input_n=10):
        ...
        input_gcn, restoration_loss = self.restoration(src_tmp, label)
        input_gcn = input_gcn[:, idx]
        ...
        return outputs, restoration_loss
