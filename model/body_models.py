...
from model.vertex_ids import vertex_ids as VERTEX_IDS
...
from model.vertex_joint_selector import VertexJointSelector
    ...
    def __init__(
        ...
        **kwargs
        ...
        j_regressor = to_tensor(to_np(
            data_struct.V_regressor), dtype=dtype)
        ...
        parents = to_tensor(to_np(data_struct.kintree_table)).long()
        parents[0] = -1
