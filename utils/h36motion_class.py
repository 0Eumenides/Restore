...
class Datasets(Dataset):
    ...
    def __init__(self, opt, actions=None, split=0):
        ...
        label_dict = {"walking": 0, "eating": 1, "smoking": 2, "discussion": 3, "directions": 4,
                        "greeting": 5, "phoning": 6, "posing": 7, "purchases": 8, "sitting": 9,
                        "sittingdown": 10, "takingphoto": 11, "waiting": 12, "walkingdog": 13,
                        "walkingtogether": 14}
            ...
            for action_idx in np.arange(len(acts)):
                ...
                if self.split <= 1:
                    for subact in [1, 2]:  # subactions
                        ...
                        self.label[key] = label_dict[action]
                    ...
                    self.label[key + 1] = label_dict[action]
    ...
    def __getitem__(self, item):
        ...
        return self.p3d[key][fs],self.label[key]
